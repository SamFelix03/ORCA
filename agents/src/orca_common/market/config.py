...
class MarketDataSettingsMixin(BaseSettings):
    ...
    goldsky_api_base_url: str = Field(default="", alias="GOLDSKY_API_BASE_URL")
    goldsky_api_key: str = Field(default="", alias="GOLDSKY_API_KEY")
    ...
    goldsky_subgraph_id: str = Field(default="", alias="GOLDSKY_SUBGRAPH_ID")
